            ...
            <div className="w-full max-w-sm bg-neutral-primary-soft p-6   rounded-xl shadow-xs" key={item.id}>
              ...
              <div>
                ...
                <div className="flex items-center justify-between mt-6">
                  ...
                  <button
                    type="button"
                    className="inline-flex items-center  bg-white text-black rounded-xl bg-brand hover:bg-brand-strong box-border border border-transparent focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-3 py-2 focus:outline-none"
                  >
                    <svg
